...
var uncompress = function uncompress2(data) {
  ...
  for (var id2 in data.emojis) {
    var emoji = data.emojis[id2];
...
function sanitize(emoji) {
  var name = emoji.name, short_names = emoji.short_names, skin_tone = emoji.skin_tone, skin_variations = emoji.skin_variations, emoticons2 = emoji.emoticons, unified = emoji.unified, custom2 = emoji.custom, customCategory = emoji.customCategory, imageUrl = emoji.imageUrl, id2 = emoji.id || short_names[0], colons = ":".concat(id2, ":");
  if (custom2) {
    return {
      id: id2,
      name,
...
function getData(emoji, skin, set2, data) {
  var emojiData = {};
  ...
  if (emojiData.skin_variations && skin > 1) {
    ...
    if (variationData) {
      ...
      if (set2 && (variationData["has_img_".concat(set2)] == void 0 || variationData["has_img_".concat(set2)]) || !set2) {
...
function getEmojiDataFromNative(nativeString, set2, data) {
  if (data.compressed) {
    uncompress(data);
  }
  ...
  return getSanitizedData(emojiData, skin, set2, data);
}
function uniq(arr) {
...
var NimbleEmojiIndex = function() {
  function NimbleEmojiIndex2(data, set2) {
    _classCallCheck(this, NimbleEmojiIndex2);
    if (data.compressed) {
      uncompress(data);
    }
    this.data = data || {};
  ...
  _createClass(NimbleEmojiIndex2, [{
    key: "buildIndex",
    value: function buildIndex() {
      var _this = this;
      var _loop = function _loop2(emoji2) {
        var emojiData = _this.data.emojis[emoji2], short_names = emojiData.short_names, emoticons2 = emojiData.emoticons, skin_variations = emojiData.skin_variations, id2 = short_names[0];
        if (emoticons2) {
          emoticons2.forEach(function(emoticon) {
            if (_this.emoticons[emoticon]) {
              return;
            }
            _this.emoticons[emoticon] = id2;
          });
        }
        if (skin_variations) {
          _this.emojis[id2] = {};
          for (var skinTone = 1; skinTone <= 6; skinTone++) {
            _this.emojis[id2][skinTone] = getSanitizedData({
              id: id2,
              skin: skinTone
            }, skinTone, _this.set, _this.data);
          }
        } else {
          _this.emojis[id2] = getSanitizedData(id2, null, _this.set, _this.data);
        }
        _this.originalPool[id2] = emojiData;
      };
    ...
    key: "addCustomToPool",
    value: function addCustomToPool(custom2, pool) {
      var _this3 = this;
      if (this.customEmojisList.length)
        this.clearCustomEmojis(pool);
      custom2.forEach(function(emoji) {
        var emojiId = emoji.id || emoji.short_names[0];
      ...
      this.customEmojisList = custom2;
      this.index = {};
    }
  }, {
    key: "search",
    value: function search4(value) {
      var _this4 = this;
      var _ref = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, emojisToShowFilter = _ref.emojisToShowFilter, maxResults = _ref.maxResults, include = _ref.include, exclude = _ref.exclude, _ref$custom = _ref.custom, custom2 = _ref$custom === void 0 ? [] : _ref$custom;
      if (this.customEmojisList != custom2)
        this.addCustomToPool(custom2, this.originalPool);
      var skinTone = store_default.get("skin") || 1;
        ...
        if (include.length || exclude.length) {
          ...
          if (custom2.length) {
            ...
            if (customIsIncluded && !customIsExcluded) {
              this.addCustomToPool(custom2, pool);
            }
          }
        }
          ...
          for (var charIndex = 0; charIndex < value2.length; charIndex++) {
            ...
            if (!aIndex.results) {
              (function() {
                ...
                aIndex.results = [];
                aIndex.pool = {};
                for (var id2 in aPool) {
                  var emoji = aPool[id2], search5 = emoji.search, sub = value2.substr(0, length), subIndex = search5.indexOf(sub);
                  if (subIndex != -1) {
                    var score = subIndex + 1;
                    if (sub == id2)
                      score = 0;
                    if (_this4.emojis[id2] && _this4.emojis[id2][skinTone]) {
                      aIndex.results.push(_this4.emojis[id2][skinTone]);
                    } else {
                      aIndex.results.push(_this4.emojis[id2]);
                    }
...
var emojiIndex = new NimbleEmojiIndex(all_default);
var emojis2 = emojiIndex.emojis;
var emoticons = emojiIndex.emoticons;
function search() {
  return emojiIndex.search.apply(emojiIndex, arguments);
}
var emoji_index_default = {
  search,
  emojis: emojis2,
  emoticons
};
...
function add(emoji) {
  ...
  frequently[id2] || (frequently[id2] = 0);
  frequently[id2] += 1;
  store_default.set("last", id2);
  store_default.set("frequently", frequently);
}
function get2(perLine) {
  if (!initialized)
    init();
  if (!frequently) {
    defaults = {};
  ...
  var last = store_default.get("last");
...
var EmojiPropTypes = {
  ...
  onOver: import_prop_types.default.func,
  onLeave: import_prop_types.default.func,
  onClick: import_prop_types.default.func,
  fallback: import_prop_types.default.func,
  backgroundImageFn: import_prop_types.default.func,
  "native": import_prop_types.default.bool,
  forceSize: import_prop_types.default.bool,
  tooltip: import_prop_types.default.bool,
  useButton: import_prop_types.default.bool,
  skin: import_prop_types.default.oneOf([1, 2, 3, 4, 5, 6]),
  sheetSize: import_prop_types.default.oneOf([16, 20, 32, 64]),
  sheetColumns: import_prop_types.default.number,
  sheetRows: import_prop_types.default.number,
  set: import_prop_types.default.oneOf(["apple", "google", "twitter", "facebook"]),
  size: import_prop_types.default.number.isRequired,
  emoji: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.object]).isRequired
};
var PickerPropTypes = {
  onClick: import_prop_types.default.func,
  onSelect: import_prop_types.default.func,
  onSkinChange: import_prop_types.default.func,
  perLine: import_prop_types.default.number,
  emojiSize: import_prop_types.default.number,
  i18n: import_prop_types.default.object,
  style: import_prop_types.default.object,
  title: import_prop_types.default.string,
  emoji: import_prop_types.default.string,
  ...
  emojisToShowFilter: import_prop_types.default.func,
  showPreview: import_prop_types.default.bool,
  showSkinTones: import_prop_types.default.bool,
  emojiTooltip: EmojiPropTypes.tooltip,
  useButton: EmojiPropTypes.useButton,
  theme: import_prop_types.default.oneOf(["auto", "light", "dark"]),
  include: import_prop_types.default.arrayOf(import_prop_types.default.string),
  exclude: import_prop_types.default.arrayOf(import_prop_types.default.string),
  recent: import_prop_types.default.arrayOf(import_prop_types.default.string),
  autoFocus: import_prop_types.default.bool,
  enableFrequentEmojiSort: import_prop_types.default.bool,
  custom: import_prop_types.default.arrayOf(import_prop_types.default.shape({
    name: import_prop_types.default.string.isRequired,
    short_names: import_prop_types.default.arrayOf(import_prop_types.default.string).isRequired,
    emoticons: import_prop_types.default.arrayOf(import_prop_types.default.string),
    keywords: import_prop_types.default.arrayOf(import_prop_types.default.string),
    imageUrl: import_prop_types.default.string,
    spriteUrl: import_prop_types.default.string,
    sheet_x: import_prop_types.default.number,
    sheet_y: import_prop_types.default.number,
    size: import_prop_types.default.number,
    sheetColumns: import_prop_types.default.number,
    sheetRows: import_prop_types.default.number
  })),
  skinEmoji: import_prop_types.default.string,
  notFound: import_prop_types.default.func,
  notFoundEmoji: import_prop_types.default.string,
...
var Anchors = function(_React$PureComponent) {
  _inherits(Anchors2, _React$PureComponent);
  function Anchors2(props) {
    var _this;
    _classCallCheck(this, Anchors2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Anchors2).call(this, props));
  ...
  _createClass(Anchors2, [{
    ...
    value: function handleClick(e) {
      ...
      var _this$props = this.props, categories3 = _this$props.categories, onAnchorClick2 = _this$props.onAnchorClick;
      onAnchorClick2(categories3[index], index);
    }
  }, {
    key: "render",
    value: function render() {
      var _this2 = this;
      var _this$props2 = this.props, categories3 = _this$props2.categories, color = _this$props2.color, i18n = _this$props2.i18n, icons = _this$props2.icons, selected = this.state.selected;
      return import_react2.default.createElement("nav", {
        className: "emoji-mart-anchors",
        "aria-label": i18n.categorieslabel
      }, categories3.map(function(category, i) {
        var id2 = category.id, name = category.name, anchor = category.anchor, isSelected = name == selected;
        if (anchor === false) {
          return null;
        }
        var iconId = id2.startsWith("custom-") ? "custom" : id2;
        return import_react2.default.createElement("button", {
          key: id2,
        ...
        }, icons.categories[iconId]()), import_react2.default.createElement("span", {
...
Anchors.propTypes = {
  categories: import_prop_types2.default.array,
  onAnchorClick: import_prop_types2.default.func,
  icons: import_prop_types2.default.object
};
...
var EmojiDefaultProps = {
  ...
  tooltip: false,
  useButton: true,
  backgroundImageFn: function backgroundImageFn(set2, sheetSize) {
    return "https://unpkg.com/emoji-datasource-".concat(set2, "@").concat("5.0.1", "/img/").concat(set2, "/sheets-256/").concat(sheetSize, ".png");
  }
};
...
var _getData = function _getData2(props) {
  var emoji = props.emoji, skin = props.skin, set2 = props.set, data = props.data;
  return getData(emoji, skin, set2, data);
};
var _getPosition = function _getPosition2(props) {
  var _getData22 = _getData(props), sheet_x = _getData22.sheet_x, sheet_y = _getData22.sheet_y, multiplyX = 100 / (props.sheetColumns - 1), multiplyY = 100 / (props.sheetRows - 1);
  return "".concat(multiplyX * sheet_x, "% ").concat(multiplyY * sheet_y, "%");
};
var _getSanitizedData = function _getSanitizedData2(props) {
  var emoji = props.emoji, skin = props.skin, set2 = props.set, data = props.data;
  return getSanitizedData(emoji, skin, set2, data);
};
var _handleClick = function _handleClick2(e, props) {
  if (!props.onClick) {
    return;
  }
  var onClick2 = props.onClick, emoji = _getSanitizedData(props);
  onClick2(emoji, e);
};
...
var NimbleEmoji = function NimbleEmoji2(props) {
  ...
  var unified = data.unified, custom2 = data.custom, short_names = data.short_names, imageUrl = data.imageUrl, style = {}, children = props.children, className = "emoji-mart-emoji", nativeEmoji = unified && unifiedToNative(unified), label = [nativeEmoji].concat(short_names).filter(Boolean).join(", "), title = null;
  if (!unified && !custom2) {
    if (props.fallback) {
  ...
  if (props.html) {
    ...
    return import_react3.default.createElement(Tag.name, _extends({
      ...
      title,
      className
    }, Tag.props), import_react3.default.createElement("span", {
      style
    }, children));
  }
};
NimbleEmoji.propTypes = _objectSpread({}, EmojiPropTypes, {
  data: import_prop_types3.default.object.isRequired
});
NimbleEmoji.defaultProps = EmojiDefaultProps;
var nimble_emoji_default = NimbleEmoji;
...
var NotFound = function(_React$PureComponent) {
  _inherits(NotFound2, _React$PureComponent);
  function NotFound2() {
    _classCallCheck(this, NotFound2);
    return _possibleConstructorReturn(this, _getPrototypeOf(NotFound2).apply(this, arguments));
  }
  _createClass(NotFound2, [{
    key: "render",
    value: function render() {
      var _this$props = this.props, data = _this$props.data, emojiProps = _this$props.emojiProps, i18n = _this$props.i18n, notFound2 = _this$props.notFound, notFoundEmoji = _this$props.notFoundEmoji;
      var component = notFound2 && notFound2() || import_react4.default.createElement("div", {
        className: "emoji-mart-no-results"
      }, nimble_emoji_default(_objectSpread2({
        data
      }, emojiProps, {
        size: 38,
        emoji: notFoundEmoji,
...
NotFound.propTypes = {
  notFound: import_prop_types4.default.func.isRequired,
  emojiProps: import_prop_types4.default.object.isRequired
};
...
var Category = function(_React$Component) {
  _inherits(Category2, _React$Component);
  function Category2(props) {
    var _this;
    _classCallCheck(this, Category2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Category2).call(this, props));
  ...
  _createClass(Category2, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      var _this$props = this.props, name = _this$props.name, perLine = _this$props.perLine, _native = _this$props["native"], hasStickyPosition = _this$props.hasStickyPosition, emojis3 = _this$props.emojis, emojiProps = _this$props.emojiProps, skin = emojiProps.skin, size = emojiProps.size, set2 = emojiProps.set, nextPerLine = nextProps.perLine, nextNative = nextProps["native"], nextHasStickyPosition = nextProps.hasStickyPosition, nextEmojis = nextProps.emojis, nextEmojiProps = nextProps.emojiProps, nextSkin = nextEmojiProps.skin, nextSize = nextEmojiProps.size, nextSet = nextEmojiProps.set, shouldUpdate = false;
      if (name == "Recent" && perLine != nextPerLine) {
        shouldUpdate = true;
      }
      if (name == "Search") {
        shouldUpdate = !(emojis3 == nextEmojis);
      }
      if (skin != nextSkin || size != nextSize || _native != nextNative || set2 != nextSet || hasStickyPosition != nextHasStickyPosition) {
        shouldUpdate = true;
      }
      return shouldUpdate;
    }
    ...
    value: function getEmojis() {
      var _this2 = this;
      var _this$props2 = this.props, name = _this$props2.name, emojis3 = _this$props2.emojis, recent2 = _this$props2.recent, perLine = _this$props2.perLine;
      if (name == "Recent") {
        var custom2 = this.props.custom;
        var frequentlyUsed = recent2 || frequently_default.get(perLine);
        if (frequentlyUsed.length) {
          emojis3 = frequentlyUsed.map(function(id2) {
            var emoji = custom2.filter(function(e) {
              return e.id === id2;
            })[0];
            if (emoji) {
              return emoji;
            ...
            return !!getData(id2, null, null, _this2.data);
          });
        }
        if (emojis3.length === 0 && frequentlyUsed.length > 0) {
          return null;
        }
      }
      if (emojis3) {
        emojis3 = emojis3.slice(0);
      }
      return emojis3;
    }
  }, {
    ...
    value: function updateDisplay(display) {
      var emojis3 = this.getEmojis();
      if (!emojis3 || !this.container) {
        return;
      }
    ...
    value: function render() {
      var _this3 = this;
      var _this$props3 = this.props, id2 = _this$props3.id, name = _this$props3.name, hasStickyPosition = _this$props3.hasStickyPosition, emojiProps = _this$props3.emojiProps, i18n = _this$props3.i18n, notFound2 = _this$props3.notFound, notFoundEmoji = _this$props3.notFoundEmoji, emojis3 = this.getEmojis(), labelStyles = {}, labelSpanStyles = {}, containerStyles = {};
      if (!emojis3) {
        containerStyles = {
          display: "none"
        };
      ...
      var label = i18n.categories[id2] || name;
      return import_react5.default.createElement("section", {
        ...
        "aria-hidden": true
      }, label)), import_react5.default.createElement("ul", {
        className: "emoji-mart-category-list"
      }, emojis3 && emojis3.map(function(emoji) {
        return import_react5.default.createElement("li", {
          key: emoji.short_names && emoji.short_names.join("_") || emoji
        }, nimble_emoji_default(_objectSpread3({
          emoji,
          data: _this3.data
        }, emojiProps)));
      })), emojis3 && !emojis3.length && import_react5.default.createElement(NotFound, {
        i18n,
        notFound: notFound2,
        notFoundEmoji,
        data: this.data,
...
Category.propTypes = {
  emojis: import_prop_types5.default.array,
  hasStickyPosition: import_prop_types5.default.bool,
  name: import_prop_types5.default.string.isRequired,
  "native": import_prop_types5.default.bool.isRequired,
  perLine: import_prop_types5.default.number.isRequired,
  emojiProps: import_prop_types5.default.object.isRequired,
  recent: import_prop_types5.default.arrayOf(import_prop_types5.default.string),
  notFound: import_prop_types5.default.func,
  notFoundEmoji: import_prop_types5.default.string.isRequired
};
...
var Skins = function(_React$PureComponent) {
  _inherits(Skins2, _React$PureComponent);
  function Skins2(props) {
    var _this;
    _classCallCheck(this, Skins2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Skins2).call(this, props));
    _this.state = {
      opened: false
    };
    return _this;
  ...
  _createClass(Skins2, [{
    ...
    value: function handleClick(e) {
      ...
      var onChange5 = this.props.onChange;
  ...
  return Skins2;
}(import_react6.default.PureComponent);
Skins.propTypes = {
  onChange: import_prop_types6.default.func,
  skin: import_prop_types6.default.number.isRequired
};
Skins.defaultProps = {
...
var SkinsEmoji = function(_Skins) {
  _inherits(SkinsEmoji2, _Skins);
  function SkinsEmoji2(props) {
    var _this;
    _classCallCheck(this, SkinsEmoji2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SkinsEmoji2).call(this, props));
    _this.handleClick = _this.handleClick.bind(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(SkinsEmoji2, [{
    key: "render",
    value: function render() {
      ...
      for (var skinTone = 1; skinTone <= 6; skinTone++) {
        ...
        skinToneNodes.push(import_react7.default.createElement("span", {
...
SkinsEmoji.propTypes = {
  ...
  skin: import_prop_types7.default.number.isRequired,
  emojiProps: import_prop_types7.default.object.isRequired,
  skinTone: import_prop_types7.default.number,
  skinEmoji: import_prop_types7.default.string.isRequired,
  i18n: import_prop_types7.default.object
};
...
var SkinsDot = function(_Skins) {
  _inherits(SkinsDot2, _Skins);
  function SkinsDot2(props) {
    var _this;
    _classCallCheck(this, SkinsDot2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SkinsDot2).call(this, props));
    _this.handleClick = _this.handleClick.bind(_assertThisInitialized(_this));
    _this.handleKeyDown = _this.handleKeyDown.bind(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(SkinsDot2, [{
    key: "handleKeyDown",
    ...
    value: function render() {
      ...
      for (var skinTone = 1; skinTone <= 6; skinTone++) {
        ...
        skinToneNodes.push(import_react8.default.createElement("span", _extends({
          key: "skin-tone-".concat(skinTone),
          ...
          role: "menuitem"
        } : {}), import_react8.default.createElement("span", _extends({
          onClick: this.handleClick,
      ...
      }, import_react8.default.createElement("div", opened ? {
        role: "menubar"
      } : {}, skinToneNodes));
    }
  }]);
...
SkinsDot.propTypes = {
  ...
  skin: import_prop_types8.default.number.isRequired,
  i18n: import_prop_types8.default.object
};
...
var Preview = function(_React$PureComponent) {
  _inherits(Preview2, _React$PureComponent);
  function Preview2(props) {
    var _this;
    _classCallCheck(this, Preview2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Preview2).call(this, props));
    _this.data = props.data;
    _this.state = {
      emoji: null
    };
  ...
  _createClass(Preview2, [{
    ...
    value: function render() {
      ...
      if (emoji && showPreview) {
        var emojiData = getData(emoji, null, null, this.data), _emojiData$emoticons = emojiData.emoticons, emoticons2 = _emojiData$emoticons === void 0 ? [] : _emojiData$emoticons, knownEmoticons = [], listedEmoticons = [];
        emoticons2.forEach(function(emoticon) {
        ...
        return import_react9.default.createElement("div", {
          ...
          "aria-hidden": "true"
        }, nimble_emoji_default(_objectSpread4({
          key: emoji.id,
          emoji,
          data: this.data
        }, emojiProps))), import_react9.default.createElement("div", {
          className: "emoji-mart-preview-data",
          "aria-hidden": "true"
        }, import_react9.default.createElement("div", {
          className: "emoji-mart-preview-name"
        }, emoji.name), import_react9.default.createElement("div", {
        ...
        return import_react9.default.createElement("div", {
          ...
          className: "emoji-mart-preview-emoji",
          "aria-hidden": "true"
        }, idleEmoji && idleEmoji.length && nimble_emoji_default(_objectSpread4({
          emoji: idleEmoji,
          data: this.data
        }, emojiProps))), import_react9.default.createElement("div", {
          className: "emoji-mart-preview-data",
        ...
        }, title)), showSkinTones && import_react9.default.createElement("div", {
          className: "emoji-mart-preview-skins".concat(skinsProps.skinEmoji ? " custom" : "")
        }, skinsProps.skinEmoji ? import_react9.default.createElement(SkinsEmoji, {
        ...
        }) : import_react9.default.createElement(SkinsDot, {
          skin: skinsProps.skin,
          i18n,
          onChange: skinsProps.onChange
        })));
...
Preview.propTypes = {
  showSkinTones: import_prop_types9.default.bool,
  title: import_prop_types9.default.string.isRequired,
  emoji: import_prop_types9.default.string.isRequired,
  emojiProps: import_prop_types9.default.object.isRequired,
  skinsProps: import_prop_types9.default.object.isRequired
};
...
var Search = function(_React$PureComponent) {
  _inherits(Search2, _React$PureComponent);
  function Search2(props) {
    var _this;
    _classCallCheck(this, Search2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Search2).call(this, props));
    _this.state = {
      icon: search2.search,
      isSearching: false,
      id: ++id
  ...
  _createClass(Search2, [{
    ...
    value: function render() {
      ...
      var _this$state = this.state, icon = _this$state.icon, isSearching = _this$state.isSearching, id2 = _this$state.id;
      var inputId = "emoji-mart-search-".concat(id2);
      return import_react10.default.createElement("section", {
        ...
        htmlFor: inputId
      }, i18n.search), import_react10.default.createElement("button", {
...
Search.propTypes = {
  onSearch: import_prop_types10.default.func,
  maxResults: import_prop_types10.default.number,
  emojisToShowFilter: import_prop_types10.default.func,
...
var NimblePicker = function(_React$PureComponent) {
  _inherits(NimblePicker2, _React$PureComponent);
  function NimblePicker2(props) {
    var _this;
    _classCallCheck(this, NimblePicker2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NimblePicker2).call(this, props));
    _this.CUSTOM = [];
    ...
    _this.icons = deepMerge(svgs_exports, props.icons);
    _this.state = {
      firstRender: true
    };
    _this.categories = [];
    ...
    if (props.custom.length > 0) {
      ...
      props.custom.forEach(function(emoji2) {
        if (!customCategories[emoji2.customCategory]) {
          customCategories[emoji2.customCategory] = {
            id: emoji2.customCategory ? "custom-".concat(emoji2.customCategory) : "custom",
            name: emoji2.customCategory || "Custom",
            emojis: [],
            anchor: customCategoriesCreated === 0
          };
          customCategoriesCreated++;
        }
        var category2 = customCategories[emoji2.customCategory];
        var customEmoji = _objectSpread5({}, emoji2, {
          id: emoji2.short_names[0],
          custom: true
        });
        category2.emojis.push(customEmoji);
    ...
    for (var categoryIndex = 0; categoryIndex < allCategories.length; categoryIndex++) {
      ...
      if (props.emojisToShowFilter) {
        var newEmojis = [];
        var emojis3 = category.emojis;
        for (var emojiIndex2 = 0; emojiIndex2 < emojis3.length; emojiIndex2++) {
          var emoji = emojis3[emojiIndex2];
  ...
  _createClass(NimblePicker2, [{
    ...
    value: function handleScrollPaint() {
      ...
      if (this.SEARCH_CATEGORY.emojis) {
        ...
        if (scrollTop < minTop) {
          activeCategory = this.categories.filter(function(category2) {
            return !(category2.anchor === false);
          })[0];
    ...
    key: "handleSearch",
    value: function handleSearch(emojis3) {
      this.SEARCH_CATEGORY.emojis = emojis3;
      for (var i = 0, l = this.categories.length; i < l; i++) {
        var component = this.categoryRefs["category-".concat(i)];
        if (component && component.props.name != "Search") {
          var display = emojis3 ? "none" : "inherit";
    ...
    value: function handleAnchorClick(category, i) {
      ...
      scrollToComponent = function scrollToComponent2() {
        if (component) {
    ...
    value: function handleSkinChange(skin) {
      var newState = {
        skin
      }, onSkinChange2 = this.props.onSkinChange;
      this.setState(newState);
      store_default.update(newState);
      onSkinChange2(skin);
    }
  }, {
    key: "handleKeyDown",
    ...
    value: function render() {
      var _this4 = this;
      var _this$props = this.props, perLine = _this$props.perLine, emojiSize = _this$props.emojiSize, set2 = _this$props.set, sheetSize = _this$props.sheetSize, sheetColumns = _this$props.sheetColumns, sheetRows = _this$props.sheetRows, style = _this$props.style, title = _this$props.title, emoji = _this$props.emoji, color = _this$props.color, _native = _this$props["native"], backgroundImageFn2 = _this$props.backgroundImageFn, emojisToShowFilter = _this$props.emojisToShowFilter, showPreview = _this$props.showPreview, showSkinTones = _this$props.showSkinTones, emojiTooltip = _this$props.emojiTooltip, useButton = _this$props.useButton, include = _this$props.include, exclude = _this$props.exclude, recent2 = _this$props.recent, autoFocus = _this$props.autoFocus, skinEmoji = _this$props.skinEmoji, notFound2 = _this$props.notFound, notFoundEmoji = _this$props.notFoundEmoji;
      var width = perLine * (emojiSize + 12) + 12 + 2 + measureScrollbar();
      var theme = this.getPreferredTheme();
      var skin = this.props.skin || this.state.skin || store_default.get("skin") || this.props.defaultSkin;
      return import_react11.default.createElement("section", {
      ...
      }, import_react11.default.createElement(Anchors, {
        ...
        icons: this.icons
      })), import_react11.default.createElement(Search, {
        ...
        return import_react11.default.createElement(Category, {
          ...
          data: _this4.data,
          i18n: _this4.i18n,
          recent: category.id == _this4.RECENT_CATEGORY.id ? recent2 : void 0,
          custom: category.id == _this4.RECENT_CATEGORY.id ? _this4.CUSTOM : void 0,
          emojiProps: {
            "native": _native,
            skin,
            size: emojiSize,
            ...
            backgroundImageFn: backgroundImageFn2,
            useButton,
      ...
      })), (showPreview || showSkinTones) && import_react11.default.createElement("div", {
        className: "emoji-mart-bar"
      }, import_react11.default.createElement(Preview, {
  ...
  return NimblePicker2;
}(import_react11.default.PureComponent);
NimblePicker.propTypes = _objectSpread5({}, PickerPropTypes, {
  data: import_prop_types11.default.object.isRequired
});
NimblePicker.defaultProps = _objectSpread5({}, PickerDefaultProps);
...
var Picker = function(_React$PureComponent) {
  _inherits(Picker2, _React$PureComponent);
  function Picker2() {
    _classCallCheck(this, Picker2);
    return _possibleConstructorReturn(this, _getPrototypeOf(Picker2).apply(this, arguments));
  }
  _createClass(Picker2, [{
    key: "render",
    value: function render() {
      return import_react12.default.createElement(NimblePicker, _extends({}, this.props, this.state));
    }
  }]);
  return Picker2;
}(import_react12.default.PureComponent);
Picker.propTypes = PickerPropTypes;
Picker.defaultProps = _objectSpread6({}, PickerDefaultProps, {
  data: all_default
});
...
var Emoji = function Emoji2(props) {
  for (var k in Emoji2.defaultProps) {
    if (props[k] == void 0 && Emoji2.defaultProps[k] != void 0) {
      props[k] = Emoji2.defaultProps[k];
    }
  }
  return nimble_emoji_default(_objectSpread7({}, props));
};
Emoji.propTypes = EmojiPropTypes;
Emoji.defaultProps = _objectSpread7({}, EmojiDefaultProps, {
  data: all_default
});
...
export {
  ...
  nimble_emoji_default as NimbleEmoji,
  NimbleEmojiIndex,
  NimblePicker,
  Picker,
  emoji_index_default as emojiIndex,
